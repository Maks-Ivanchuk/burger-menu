...
function Burger() {
   ...
   const userCaviben = () => {
            ...
            <div class="user__wrapper">
               <div class="user__cabinet">
                  <div class="user__logo">
                     <img src="..src/img/user.png" alt="user image" />
                  </div>
                  <div class="user__info">
                     <h2>Erin Brockovich</h2>
                  </div>
                  <div class="user__order">
                     <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum, provident eaque molestiae ullam quod
                        quas facere sed deserunt harum nesciunt cum voluptates expedita a, at excepturi ipsa, eius quo nulla?</span>
                     <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum, provident eaque molestiae ullam quod
                        quas facere sed deserunt harum nesciunt cum voluptates expedita a, at excepturi ipsa, eius quo nulla?</span>
                     <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum, provident eaque molestiae ullam quod
                        quas facere sed deserunt harum nesciunt cum voluptates expedita a, at excepturi ipsa, eius quo nulla?</span>
      ...
      return (
         header.insertAdjacentHTML("afterend", userInfoHTML)
      );
   };
            ...
            <div className="container">
               ...
               <div className={isOpen ? 'header__nav header__nav--active' : 'header__nav'}>
                  ...
                  <div className="nav__client" >
                     <a className="client__item" href="#" onClick={() => {
                        toggleHeaderMenu();
                        userCaviben()
                     }}>
                     ...
                     <a className="client__item" href="#" onClick={toggleHeaderMenu}>
